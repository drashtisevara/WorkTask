                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLongTitle">Add Accounts</h5>
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-horizontal">
                                        <form action="{{ url('update/'.$accounts->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="account_number" class="form-control"
                                                    placeholder="" aria-describedby="helpId" name="account_number"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="total_balance" class="form-control"
                                                    placeholder="" aria-describedby="helpId" name="total_balance"
                                                    value="{{$accounts->total_balance}}">
                                                <!-- <small id="helpId" class="text-muted">Help text</small> -->
                                            </div>

                                            <div class="mb-3">
                                                <label for="">Total Transactions</label>
                                                <input type="text" name="total_transaction" class="form-control"
                                                    placeholder="" aria-describedby="helpId" name="total_transaction"
                                                    value="{{$accounts->total_transaction}}">
                                                <!-- <small id="helpId" class="text-muted">Help text</small> -->
                                            </div>

                                            <div class="mb-3">
                                                <label for="">Total Deduct</label>
                                                <input type="text" name="total_deduct" class="form-control"
                                                    placeholder="" aria-describedby="helpId" name="total_deduct"
                                                    value="{{$accounts->total_deduct}}">
                                                <!-- <small id="helpId" class="text-muted">Help text</small> -->
                                            </div>
